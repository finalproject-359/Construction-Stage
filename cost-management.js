...
const buildDetailsMarkup = (project, rows) => {
  ...
  <article class="kpi-card"><h4><span class="kpi-icon">💳</span>Total Planned Cost</h4><p>${formatBudget(plannedCost)}</p></article>
  <article class="kpi-card"><h4><span class="kpi-icon">🧾</span>Total Actual Cost</h4><p>${formatBudget(actualCost)}</p></article>
