...
const buildDetailsMarkup = (project, rows) => {
  ...
  <article class="kpi-card"><h4><span class="kpi-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M12 4v16"/><path d="M7 8h10"/><path d="m5.5 8-2.5 4h5l-2.5-4Zm13 0-2.5 4h5l-2.5-4Z"/><path d="M8 12a3 3 0 0 1-6 0M22 12a3 3 0 0 1-6 0"/></svg></span>Variance</h4><p class="${varianceClass}">${formatBudget(variance)}</p><small>${varianceLabel}</small></article>
